...
The transition relation is implemented using a function that computes transitions.
...
match on a given editor expression and type check on a case by case basis.
